...
<body>
	<div class="wrapper">
    <div ><marquee><h1 style="color:red">Database (excel) file uploaded successfuly</h1></marquee> </div>
      ...
      <!-- <input type="submit" name = "submit" value="upload"> -->
	   <!-- </td> -->
				...
				<tr>
					...
					<td>
                    <label for="sample_file">Upload Database</label><br>
                        <input type="file" name="sample_file" required style="margin: 20px;">
                ...
                <tr>
					<td colspan="3" align="center">
                         ...
                         <a class="btn btn-outline-danger" aria-current="page" href="edited.php">Go Back</a>
					</td>
				</tr>
			</table>
