...
<body>
	<div class="wrapper">
    <div><marquee><h1 style="color:red">Medicine registered successfully..!</h1></marquee> </div>
      ...
      <!-- <input type="submit" name = "submit" value="upload"> -->
				...
				<tr>
					...
					<!-- Upload DB: <input type="file" name="sample_file"> -->
                         ...
                         <a class="btn btn-outline-danger" aria-current="page" href="edited.php" style="margin-left: 25px;">Go Back</a>
						 </form>	
